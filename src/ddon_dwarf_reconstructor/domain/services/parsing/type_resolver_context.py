...
class TypeResolverContext(Protocol):
    ...
    def _resolve_qualified_type(self, type_die: DIE) -> str: ...
    ...
    def _named_type_name(self, type_die: DIE) -> str: ...

    def _resolve_array_type(self, type_die: DIE) -> str: ...

    def _resolve_referenced_name(
        self, type_die: DIE, missing_name: str, suffix: str = ""
    ) -> str: ...

    def _resolve_member_pointer_name(self, type_die: DIE) -> str: ...

    def _resolve_subroutine_name(self, type_die: DIE) -> str: ...

    def _named_or_typedef_name(self, type_die: DIE) -> str: ...

    def _qualified_primitive_name(self, type_die: DIE) -> str: ...

    def _special_primitive_name(self, type_die: DIE) -> str: ...

    def _die_name(self, type_die: DIE) -> str | None: ...
    ...
    def _resolve_primitive_die(self, type_name: str, die: DIE) -> str | None: ...
