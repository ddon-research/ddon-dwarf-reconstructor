...
class TestDwarfGenerator:
    ...
    def mock_elf_file(self) -> Mock:
        ...
        mock_line_program.header = {
            'file_entry': [mock_file1, mock_file2]
        }
    ...
    def mock_die(self) -> Mock:
        ...
        mock_die.iter_children.return_value = [
            mock_vtable_member, mock_static_member, mock_dti_member,
            mock_destructor, mock_create_ui, mock_operator_new
        ]
        return mock_die
    ...
    def test_context_manager_behavior(self, mocker, mock_elf_file):
        ...
        mocker.patch("ddon_dwarf_reconstructor.generators.dwarf_generator.ELFFile", return_value=mock_elf_file)
    ...
    @pytest.mark.unit
    def test_generate_header_structure(self, mocker, mock_elf_file, mock_compilation_unit, mock_die):
    ...
    def test_no_dwarf_info_error(self, mocker):
        ...
        mocker.patch("pathlib.Path.exists", return_value=True)
        mocker.patch("builtins.open", mock_open())
        mocker.patch("ddon_dwarf_reconstructor.generators.dwarf_generator.ELFFile", return_value=mock_elf)
    ...
    def test_find_enumeration_type(self, mocker, mock_elf_file):
        ...
        mock_enum_die.iter_children.return_value = [
            mock_success_enumerator, mock_error_enumerator, mock_pending_enumerator
        ]
    ...
    def test_find_struct_with_nested_enum(self, mocker, mock_elf_file):
        ...
        mock_outer_struct.iter_children.return_value = [
            mock_nested_enum, mock_mode_member, mock_value_member
        ]
    ...
    def test_find_union_with_struct_members(self, mocker, mock_elf_file):
        ...
        mock_complex_union.iter_children.return_value = [
            mock_nested_struct, mock_coord_member, mock_raw_member
        ]
