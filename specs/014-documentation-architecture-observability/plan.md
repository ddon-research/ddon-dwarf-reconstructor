...
5. Build the site strictly, parse all Mermaid source, scan local links and retired paths, run the
   root quality and nested project loops, and repair any documentation drift found by the checks.
