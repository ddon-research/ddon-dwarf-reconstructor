...
4. Synchronize navigation, architecture index, observability links, writing guidance, roadmap, and
   instruction adapters. Keep the deferred graph integration linked to the dedicated
   [LadybugDB-first KG-001 feature record](../015-ladybugdb-knowledge-graph/spec.md). Remove
   obsolete duplicate pages and stale links.
