# Tasks: Maintainability and Architecture Hardening
...
- [x] T005 Consolidate definition selection and method evidence call sites.
- [x] T006 Split `class_parser.py` and preserve all discovery/parser behavior.
- [x] T007 Split `type_resolver.py` and complete declarator/array coverage.
- [x] T008 Split hierarchy/dependency planning and preserve qualified identities.
- [x] T009 Split `header_generator.py` and preserve exact rendered bytes.
- [x] T010 Collapse `DwarfGenerator` modes into one typed workflow.
...
## Convergence and documentation

- [x] T016 Add exact fixture and real-artifact regression checks.
